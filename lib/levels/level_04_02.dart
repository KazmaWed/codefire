...
class Level0402 extends StatefulWidget {
  const Level0402({super.key, this.initialCode});
  final String? initialCode;

  @override
  State<Level0402> createState() => _Level0402State();
}

class _Level0402State extends State<Level0402> {
